...
Единый интерфейс проекта — Makefile. Все команды реализованы непосредственно в его рецептах. Нативный запуск из Windows не поддерживается: используйте Ubuntu WSL или Linux.
